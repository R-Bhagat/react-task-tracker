    ...
    return (
        <form className="add-form" onSubmit={onSubmit}>
            <div className="form-control">
                <label>Task</label>
                <input type="text" value={text} onChange={(e)=>setText(e.target.value)} placeholder="add"/>
            </div>
            <div className="form-control">
                <label>Day And Time</label>
                <input type="text" placeholder="add and time" value={day} onChange={(e)=>setDay(e.target.value)} />
            </div>
